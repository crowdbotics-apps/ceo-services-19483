"""ceo_services_19483 URL Configuration
...
admin.site.site_header = "CEO services"
admin.site.site_title = "CEO services Admin Portal"
admin.site.index_title = "CEO services Admin"

# swagger
api_info = openapi.Info(
    title="CEO services API",
    default_version="v1",
    description="API documentation for CEO services App",
)
